...
import com.xuechng.base.exception.CommonError;
...
public class CoursePublishServiceImpl implements CoursePublishService {
    ...
    public void commitAudit(Long companyId, Long courseId) {
       ...
       CourseCategory courseCategory1 = categoryMapper.selectById(courseBaseInfo.getMt());
       CourseCategory courseCategory2 = categoryMapper.selectById(courseBaseInfo.getSt());
        coursePublishPre.setMtName(courseCategory1.getName());
        coursePublishPre.setStName(courseCategory2.getName());
